            ...
            try {
                ...
                if (getCode.equals("000")) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        schemelistmodel.Price = "";
                        schemelistmodel.PlotNo = "";
                    ...
                    Sneaker.with(getActivity())
                            .setTitle("Error!")
                            .setDuration(4000)
                            .setMessage("Login Session Expired! Please Relogin.")
                            .sneakError();
                ...
                Log.e("Wantedfragmenterror", e.getMessage());
                progressDialog.dismiss();
            }
